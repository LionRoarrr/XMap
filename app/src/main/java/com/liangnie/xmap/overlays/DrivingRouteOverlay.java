package com.liangnie.xmap.overlays;
...
//        mPolylineOptionscolor.add(MapUtil.convertToLatLng(tmcSection.get(0).getPolyline().get(0)));
        ...
        points.add(MapUtil.convertToLatLng(tmcSection.get(0).getPolyline().get(0)));
...
//				mPolylineOptionscolor.add(MapUtil.convertToLatLng(mployline.get(j)));
                points.add(MapUtil.convertToLatLng(mployline.get(j)));
